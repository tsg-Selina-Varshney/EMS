    ...
    <div className="body h-screen flex bg-cover bg-center"> 
      ...
      <div class=" middle w-full max-w-4xl shadow-4xl rounded flex items-center justify-center" >
        ...
        <form class="w-full px-10 pt-10 pb-8 mx-6 mb-6 bg-white shadow-xl">
          ...
          <div class="mb-8">
            <label class="block text-gray-700 text-2xl font-bold mb-4" for="username">
              Username
            </label>

            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xl" 
            id="username" 
            type="text" 
          ...
          <div class="mb-8">
            <label class="block text-gray-700 text-2xl font-bold mb-4" for="password">
              Password
            </label>
          ...
          <div class="flex items-center justify-between">
            <button class="bg-blue-500 hover:bg-blue-700 text-white text-lg font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" 
            type="button"
